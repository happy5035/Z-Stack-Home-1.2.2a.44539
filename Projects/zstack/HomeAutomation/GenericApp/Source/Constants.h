...
#define SAMPLE_TEMP_TIME_DELAY_DEFAULT			60000
#define TEMP_PACKET_SEND_TIME_DELAY_DEFAULT		600000
#define SAMPLE_HUM_TIME_DELAY_DEFAULT			10000
#define REQUEST_SYNC_CLOCK_DELAY_DEFAULT		600000
